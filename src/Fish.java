public class Fish {
    ...
    public Fish(String fish, int sizeInInches, String color, int speedOfMoving, String habitat, String mainFood) {
        this.fish = fish;
    ...
    public void fishDescription(){
        System.out.println("The name of the animal is "+fish);
